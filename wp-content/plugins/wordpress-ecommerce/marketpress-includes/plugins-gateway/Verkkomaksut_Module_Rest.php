...
class Verkkomaksut_Module_Rest_Payment_E1 extends Verkkomaksut_Module_Rest_Payment
{
	...
	/**
	 * @return (Verkkomaksut_Module_E1)_Contact contact data for this payment
	 */
...
class Verkkomaksut_Module_Rest
{
	...
	private function _postJsonRequest($url, $content)
	{
      ...
      'X-Verkkomaksut-Api-Version: 1'
        ...
        // Connection failure
        if ($curlError) {
            throw new Verkkomaksut_Exception('Connection failure. Please check that payment.paytrail.fi is reachable from your environment ('.$curlError.')');
        }
